...
public class bikesDB {
    ...
    static {
        ...
        bikes.add(new Bike(6, 5, "Touring Bike", "Surly", "New", "Purple", true, List.of(IMAGE_UPLOAD_DIR + "12.jpeg"),false));
        ...
        bikes.add(new Bike(11, 5, "Fat Tire Bike", "Gravel Bike", "New", "Yellow", true, List.of(IMAGE_UPLOAD_DIR + "13.jpeg"),true));
